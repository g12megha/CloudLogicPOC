...
function getRequestImpl(method, parsedUrl, headers, destination, tracer) {
  ...
  var opts = {
    ...
    port: parsedUrl.port,
    path: parsedUrl.path,
    agent: agents.get(parsedUrl.protocol, proxyUri),
