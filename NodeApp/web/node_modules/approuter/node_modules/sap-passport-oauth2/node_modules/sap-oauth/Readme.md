...
__SAP__ fork because of non merged pull request https://github.com/ciaranj/node-oauth/pull/248 which we require.

__Changes:__ Removed oauth.js; sha1.js; \_util.js; and the respective tests; examples;
